...
const parser = new PDFParse({ data: buffer, CanvasFactory });
// then use parser
Unsupported tests run on Node.js 18, 19, 21, see test_unsupported.yml.
...
If you continue to experience issues, please check the GitHub Issues page or open a new issue with details about your environment and error messages.